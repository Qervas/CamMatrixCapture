...
namespace cam_matrix::ui
{
    ...
    private slots:
        ...
        void onHighQualityPhotoCaptureRequested(int cameraIndex, const QString &format);
    ...
    private:
        ...
        QComboBox *syncFormatCombo_{nullptr};
        ...
        QPushButton *captureHQSyncButton_{nullptr};
